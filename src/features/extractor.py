...
class PairwiseFeatureExtractor:
    ...
    def extract_features(
        ...
        Returns a DataFrame containing:
          ...
          - Feature columns: ['name_ratio', 'name_token_set', 'name_partial', 'name_jw', ...]
        """
        ...
        # Vectorized / Batch pairwise string calculations using RapidFuzz
        s1_names = joined["s1_name"].to_list()
        cand_names = joined["cand_name"].to_list()
        
        s1_names_raw = joined["s1_name_raw"].to_list()
        cand_names_raw = joined["cand_names_raw" if "cand_names_raw" in joined.columns else "cand_name_raw"].to_list()
        ...
        # Preallocate numpy arrays for features
